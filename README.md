...
Jigsaw Multilingual Toxic Comment Classification 357/1621 (23%) <img alt="Kaggle" src="https://img.shields.io/badge/Kaggle%20-blue.svg" />
...
**2018년도 빅데이터 분석 준전문가 양성교육과정 강의**<br>창원대학교 LINC플러스사업단

1. **기간** - 2018년 10월 4일부터 2018년 11월 22일까지
2. **목적**
    * 재학생과 지역의 청년층에게 빅데이터 관련 교육 기회 제공
    * 사회 전반의 데이터 활용에 필수적이고 과학적 의사결정의 토대가 되는 데이터 기획 능력과 분석 능력을 가진 실무형 데이터 분석 전문가 양성
3. **수행 업무**
    * 강의 담당

---

**경영학 분야 KCI 저널의 주제어 분석**<br>참여인원: [**박세민**]()
...
3. **수행 업무**
    ...
    * 텍스트 데이터 전처리 및 적용하고자 하는 기법에 대한 선행연구를 담당
    * 논문의 작성을 담당
4. **성과** - 대한경영학회지 등재
...
**2010 호텔관광 기획디자인 공모전 우수상**<br>사단법인 한국호텔관광학회 2010년 10월 30일
...
* **NVIDIA DLI 자연어 처리** - [FUNDAMENTALS OF DEEP LEARNING FOR NATURAL LANGUAGE PROCESSING](https://courses.nvidia.com/certificates/bd64111a60754b45a4ec0065517b275b)
* **DataCamp**
...
<table>
    ...
    <tr>
        <td><img src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" height="50px"></td>
        <td><img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png" height="35px"><img src="https://www.r-project.org/logo/Rlogo.svg" height="35px"></td>
        <td><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/1920px-ISO_C%2B%2B_Logo.svg.png" height="30px"></td>
    </tr>
<table>


<!--
**unerue/unerue** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
