...
### Publications
* **<a href="">CAIR: Fast and Lightweight Multi-Scale Color Attention Network for Instagram Filter Removal</a>** `Top-tier` <br>Woon-Ha Yeo<sup>1</sup>, Wang-Taek Oh, Kyung-Su Kang, Young-Il Kim, Han-Cheol Ryu<sup>*</sup> (2022). European Conference on Computer Vision (ECCV).
